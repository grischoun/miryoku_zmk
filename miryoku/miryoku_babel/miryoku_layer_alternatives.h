...
U_MT(LCTRL, Q),    U_MT(LSHFT, S),    U_MT(LGUI, D),     U_MT(LALT, F),     &kp G,             &kp H,             U_MT(LALT, J),     U_MT(LGUI, K),     U_MT(LSHFT, L),    U_MT(LCTRL, M),    \
U_LT(U_BUTTON, W), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp COMMA,         &kp DOT,           U_MT(RALT, SLASH), U_LT(U_BUTTON, SQT),\
U_NP,              U_NP,              U_LT(U_FUN, TAB),  U_LT(U_NUM, BSPC), U_LT(U_SYM, ESC),  U_LT(U_MOUSE, RET),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_BEAKL15_FLIP \
&kp Q,             &kp H,             &kp O,             &kp U,             &kp X,             &kp G,             &kp C,             &kp R,             &kp F,             &kp Z,             \
U_MT(LCTRL, Y),    U_MT(LSHFT, I),    U_MT(LGUI, E),     U_MT(LALT, A),     &kp DOT,           &kp D,             U_MT(LALT, S),     U_MT(LGUI, T),     U_MT(LSHFT, N),    U_MT(LCTRL, B),    \
...
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     U_MT(LALT, T),     &kp D,             &kp H,             U_MT(LALT, N),     U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
...
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     U_MT(LALT, T),     &kp G,             &kp M,             U_MT(LALT, N),     U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, TAB),  U_LT(U_NUM, BSPC), U_LT(U_SYM, ESC),  U_LT(U_MOUSE, RET),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     U_MT(LALT, T),     &kp G,             &kp K,             U_MT(LALT, N),     U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
...
U_MT(LCTRL, A),    U_MT(LSHFT, O),    U_MT(LGUI, E),     U_MT(LALT, U),     &kp I,             &kp D,             U_MT(LALT, H),     U_MT(LGUI, T),     U_MT(LSHFT, N),    U_MT(LCTRL, S),    \
...
U_MT(LCTRL, S),    U_MT(LSHFT, H),    U_MT(LGUI, N),     U_MT(LALT, T),     &kp COMMA,         &kp DOT,           U_MT(LALT, A),     U_MT(LGUI, E),     U_MT(LSHFT, O),    U_MT(LCTRL, I),    \
...
U_MT(LCTRL, A),    U_MT(LSHFT, S),    U_MT(LGUI, H),     U_MT(LALT, T),     &kp G,             &kp Y,             U_MT(LALT, N),     U_MT(LGUI, E),     U_MT(LSHFT, O),    U_MT(LCTRL, I),    \
...
U_MT(LCTRL, A),    U_MT(LSHFT, S),    U_MT(LGUI, D),     U_MT(LALT, F),     &kp G,             &kp H,             U_MT(LALT, J),     U_MT(LGUI, K),     U_MT(LSHFT, L),    U_MT(LCTRL, SQT),  \
...
&kp A,             &kp Z,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LCTRL, Q),    U_MT(LSHFT, S),    U_MT(LGUI, D),     &kp F,             U_MT(LALT, G),     U_MT(LALT, H),     &kp J,             U_MT(LGUI, K),     U_MT(LSHFT, L),    U_MT(LCTRL, M),    \
U_LT(U_BUTTON, W), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp COMMA,         &kp DOT,           U_MT(RALT, SLASH), U_LT(U_BUTTON, SQT),\
...
&kp Q,             &kp H,             &kp O,             &kp U,             &kp X,             &kp G,             &kp C,             &kp R,             &kp F,             &kp Z,             \
U_MT(LCTRL, Y),    U_MT(LSHFT, I),    U_MT(LGUI, E),     &kp A,             U_MT(LALT, DOT),   U_MT(LALT, D),     &kp S,             U_MT(LGUI, T),     U_MT(LSHFT, N),    U_MT(LCTRL, B),    \
U_LT(U_BUTTON, J), U_MT(RALT, SLASH), &kp COMMA,         &kp K,             &kp SQT,           &kp W,             &kp M,             &kp L,             U_MT(RALT, P),     U_LT(U_BUTTON, V), \
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp G,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     &kp T,             U_MT(LALT, D),     U_MT(LALT, H),     &kp N,             U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp K,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     &kp T,             U_MT(LALT, G),     U_MT(LALT, M),     &kp N,             U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LSHFT, R),    U_MT(LGUI, S),     &kp T,             U_MT(LALT, G),     U_MT(LALT, K),     &kp N,             U_MT(LGUI, E),     U_MT(LSHFT, I),    U_MT(LCTRL, O),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp M,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
U_MT(LCTRL, A),    U_MT(LSHFT, O),    U_MT(LGUI, E),     &kp U,             U_MT(LALT, I),     U_MT(LALT, D),     &kp H,             U_MT(LGUI, T),     U_MT(LSHFT, N),    U_MT(LCTRL, S),    \
U_LT(U_BUTTON, SLASH),U_MT(RALT, Q),     &kp J,             &kp K,             &kp X,             &kp B,             &kp M,             &kp W,             U_MT(RALT, V),     U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
U_MT(LCTRL, S),    U_MT(LSHFT, H),    U_MT(LGUI, N),     &kp T,             U_MT(LALT, COMMA), U_MT(LALT, DOT),   &kp A,             U_MT(LGUI, E),     U_MT(LSHFT, O),    U_MT(LCTRL, I),    \
U_LT(U_BUTTON, F), U_MT(RALT, M),     &kp V,             &kp C,             &kp SLASH,         &kp G,             &kp P,             &kp X,             U_MT(RALT, K),     U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
&kp Q,             &kp D,             &kp R,             &kp W,             &kp B,             &kp J,             &kp F,             &kp U,             &kp P,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LSHFT, S),    U_MT(LGUI, H),     &kp T,             U_MT(LALT, G),     U_MT(LALT, Y),     &kp N,             U_MT(LGUI, E),     U_MT(LSHFT, O),    U_MT(LCTRL, I),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp M,             &kp C,             &kp V,             &kp K,             &kp L,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LCTRL, A),    U_MT(LSHFT, S),    U_MT(LGUI, D),     &kp F,             U_MT(LALT, G),     U_MT(LALT, H),     &kp J,             U_MT(LGUI, K),     U_MT(LSHFT, L),    U_MT(LCTRL, SQT),  \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, SPACE),U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp TAB,           &kp BSPC,          &kp ESC,           &kp RET,           &kp SPACE,         &kp ESC,           U_NP,              U_NP
...
&kp PG_DN,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,      U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
...
&kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
...
U_WH_D,            U_MS_L,            U_MS_D,            U_MS_R,            U_NU,              U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
...
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          U_NU,              U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,            \
U_NA,              &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
U_NA,              &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
...
U_RGB_EFF,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
...
&kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NA,              &u_to_U_MEDIA,     &u_to_U_FUN,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,        U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_RGB_BRI,         \
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          \
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp ESC,           &kp LALT,          U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_NUM_FLIP \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp LT,            &kp N7,            &kp N8,            &kp N9,            &kp GT,            \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp LALT,          U_NA,              &kp PLUS,          &kp N4,            &kp N5,            &kp N6,            &kp MINUS,         \
U_NA,              &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       U_NA,              &kp ASTRK,         &kp N1,            &kp N2,            &kp N3,            &kp SLASH,         \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp PRCNT,         &kp N0,            &kp PIPE,          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NUM \
&kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         &kp LALT,          &kp ESC,           &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp BSLH,          U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DOT,           &kp N0,            &kp MINUS,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_SYM_FLIP \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp CARET,         &kp LBRC,          &kp RBRC,          &kp TILDE,         &kp EXCL,          \
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp LALT,          U_NA,              &kp COLON,         &kp LPAR,          &kp RPAR,          &kp AT,            &kp ",             \
U_NA,              &kp RALT,          &u_to_U_MOUSE,     &u_to_U_SYM,       U_NA,              &kp DLLR,          &kp LBKT,          &kp RBKT,          &kp HASH,          &kp GRAVE,         \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp QMARK,         &kp SQT,           &kp AMPS,          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_SYM \
&kp LBRC,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RBRC,          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          &kp LALT,          &kp ESC,           &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
...
&kp LCTRL,         &kp LSHFT,         &kp LGUI,          &kp LALT,          U_NA,              &kp SLCK,          &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          &kp LALT,          &kp ESC,           &kp LGUI,          &kp LSHFT,         &kp LCTRL,         \
