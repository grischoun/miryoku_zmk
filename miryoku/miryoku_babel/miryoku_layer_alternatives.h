...
U_NP,              U_NP,              U_LT(U_FUN, TAB),  U_LT(U_NUM, ESC),  U_LT(U_SYM, BSPC), U_LT(U_MOUSE, RET),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_NP,              U_NP,              &kp TAB,           &kp ESC,           &kp BSPC,          &kp RET,           &kp SPACE,         &kp ESC,           U_NP,              U_NP
